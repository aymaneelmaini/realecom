...
import com.newonedev.easymart.order.application.dto.OrderLineResponse
import com.newonedev.easymart.order.application.usecase.CreateOrderUseCase
import com.newonedev.easymart.order.domain.*
...
import com.newonedev.easymart.product.application.usecase.VerifyProductsRequest
...
class DefaultCreateOrderUseCase(
    ...
    private fun createOrderLineEntities(
        ...
        productMap: Map<ProductId, com.newonedev.easymart.product.domain.Product>
