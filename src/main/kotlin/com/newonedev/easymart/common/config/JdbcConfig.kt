package com.newonedev.easymart.common.config

import com.newonedev.easymart.inventory.domain.InventoryId
...
@Configuration
@EnableJdbcRepositories(basePackages = ["com.newonedev.easymart"])
